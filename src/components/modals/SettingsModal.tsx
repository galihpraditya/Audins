          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2
                ...
                className="text-base font-semibold font-display text-fg"
              >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-fg-secondary leading-relaxed">
                      Visitors can try this app using the shared demo Groq API
                      quota (
                      <span className="font-mono text-indigo-300 font-semibold">
                        {Math.max(0, maxUploads - uploadCount)} / {maxUploads}{" "}
                        uploads left today
                      </span>
            ...
            <div className="space-y-4 text-xs text-fg-secondary leading-relaxed">
              <div className="p-4 rounded-xl bg-surface-2 border border-border space-y-2">
                ...
                <p className="text-fg-tertiary">
                  Designed & built as an interactive showcase of modern Web
                  UI/UX, React 19 architecture, Tailwind CSS v4 styling, and AI
                  audio intelligence.
                </p>
              </div>

              <div className="space-y-2">
                <p className="font-mono text-fg font-medium">
