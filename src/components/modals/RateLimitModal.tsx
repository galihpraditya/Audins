...
export default function RateLimitModal({ onClose, onSaveApiKey }: RateLimitModalProps) {
      ...
      <div className="w-full max-w-md rounded-2xl overflow-hidden bg-surface border border-border shadow-2xl animate-scale-in">
        ...
        <div className="p-6 sm:p-7">
          <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-5 bg-primary-dim border border-indigo-500/20">
            <svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 text-primary-hover">
              <path fillRule="evenodd" d="M8.485 2.495c.673-1.167 2.357-1.167 3.03 0l6.28 10.875c.673 1.167-.17 2.625-1.516 2.625H3.72c-1.347 0-2.189-1.458-1.515-2.625L8.485 2.495zM10 5a.75.75 0 01.75.75v3.5a.75.75 0 01-1.5 0v-3.5A.75.75 0 0110 5zm0 9a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
            </svg>
          </div>

          <h2 id="modal-title" className="text-lg font-semibold mb-2 font-display text-fg tracking-tight">
            Free Tier Limit Reached
          </h2>
          <p className="text-sm leading-relaxed mb-5 text-fg-secondary">
            You've reached the free processing limit for today. Wait until tomorrow, or enter your own Groq API Key to continue immediately.
          </p>
          ...
          <p className="text-xs mb-5 text-fg-tertiary flex items-center gap-1.5">
            <svg viewBox="0 0 12 12" fill="currentColor" className="w-3 h-3 opacity-60">
              <path fillRule="evenodd" d="M8.5 1.5a2.5 2.5 0 00-5 0V3H2a1 1 0 00-1 1v6a1 1 0 001 1h8a1 1 0 001-1V4a1 1 0 00-1-1H8.5V1.5zM7 1.5V3H5V1.5a1 1 0 012 0z" clipRule="evenodd" />
            </svg>
          ...
          <div className="flex items-center gap-3 mb-5 px-3 py-2.5 rounded-xl bg-surface-2 border border-border">
            <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-3.5 h-3.5 flex-shrink-0 text-fg-tertiary">
              <circle cx="7" cy="7" r="5.5" />
              <path strokeLinecap="round" d="M7 4v3.25l2 1.5" />
            </svg>
            <p className="text-xs font-mono text-fg-tertiary">
              Resets in <span className="text-fg-secondary">08h 42m</span> · Midnight UTC
            </p>
          </div>
