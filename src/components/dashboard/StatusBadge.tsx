...
import { CheckCircle, CircleNotch, WarningCircle, CloudArrowUp } from "@phosphor-icons/react"
...
export default function StatusBadge({ status, uploadProgress, size = "md" }: StatusBadgeProps) {
  const { t } = useLanguage()
  const isSm = size === "sm"
