  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center py-8 sm:py-14 px-4 sm:px-10 text-center">
        {/* Icon */}
        <div
          className={`w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-surface-2 border flex items-center justify-center mb-4 sm:mb-5 transition-colors duration-200 ${
            dragging
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2.5 mb-5 sm:mb-6 w-full sm:w-auto max-w-xs sm:max-w-none">
          ...
          >
            <Microphone
              size={15}
              weight="duotone"
              className="text-danger group-hover:scale-110 transition-transform duration-200"
            />
