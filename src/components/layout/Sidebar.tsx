...
export default function Sidebar({ screen, setScreen, setModal, onOpenSettings, uploadCount }: SidebarProps) {
  return (
    <aside className="hidden md:flex w-56 flex-shrink-0 flex-col border-r border-border bg-surface print:hidden">
      ...
      <div className="px-3 pb-4 space-y-2 border-t border-border pt-4">
        ...
        <FreeTierBar onUpgrade={() => setModal(true)} uploadCount={uploadCount} />
      </div>
    </aside>
  )
}
