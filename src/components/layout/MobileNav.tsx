...
export default function MobileNav({ screen, setScreen, setModal, onOpenSettings, uploadCount }: MobileNavProps) {
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 space-y-1">
          <NavItems screen={screen} setScreen={setScreen} onNavigate={() => setOpen(false)} />
        </nav>
