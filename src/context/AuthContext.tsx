...
interface AuthContextType {
  ...
  closeAuthModal: () => void
  login: (creds: LoginCredentials, shouldClaimGuest?: boolean) => Promise<AuthResponse>
  register: (creds: RegisterCredentials, shouldClaimGuest?: boolean) => Promise<AuthResponse>
  logout: () => void
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const syncListenersRef = useState<Set<() => Promise<void>>>(() => new Set())[0]
  ...
  const login = useCallback(
    async (creds: LoginCredentials, shouldClaimGuest = true): Promise<AuthResponse> => {
